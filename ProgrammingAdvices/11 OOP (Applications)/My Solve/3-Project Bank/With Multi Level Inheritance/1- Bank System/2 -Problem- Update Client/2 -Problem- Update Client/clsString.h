...
public:
	...
	static string UpperAllLettersOfString(string s1)
	...
	void UpperAllLettersOfString()
	{
		_Value = UpperAllLettersOfString(_Value);

	}

	static string LowerAllLettersOfString(string s1)
	{
		bool IsUpperLetter = true;
	...
	void LowerAllLettersOfString()
	{
		_Value = LowerAllLettersOfString(_Value);
	}
	...
	static string ReplaceWordInStringUsingSplit(string S1, string OldWord, string NewWord, bool MatchCase = true)
	{
		...
		for (iter = vString.begin(); iter != vString.end(); iter++)
		{
			...
			{
				if (UpperAllLettersOfString(*iter) == UpperAllLettersOfString(OldWord))
				{
					*iter = NewWord;
				}
			}
