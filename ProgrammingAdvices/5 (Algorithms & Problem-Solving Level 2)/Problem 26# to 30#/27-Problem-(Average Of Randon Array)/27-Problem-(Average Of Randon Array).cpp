...
float AverageOfNumbersInArray(int arr[100], int arrLegnth)
{
    float Sum = 0;
    for (int i = 0; i < arrLegnth; i++)
    {
...
int main()
{
    ...
    cout << "\nThe Average Of Random Numbers In Array is :" << AverageOfNumbersInArray(arr, arrLength) << endl;
