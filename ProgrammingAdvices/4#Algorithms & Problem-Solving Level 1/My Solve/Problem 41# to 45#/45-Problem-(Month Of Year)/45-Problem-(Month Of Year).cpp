...
enum enMonthOfYear { Jan = 1, Feb = 2, Mar = 3, Apr = 4, May = 5, Jon = 6, Jul = 7, Aug = 8, Sep = 9, Oct = 10, Nov = 11, Dec = 12 };
...
{
	return (enMonthOfYear)ReadNumberInRange("Please Enter Tne Number Of Month?", 1, 12);
}
