...
enDateStatus CompareDates(stDate Date1, stDate Date2)
{
     ...
     if (IsDate1EqualstDate2(Date1, Date2))
         return  enDateStatus::Equal;

        return  enDateStatus::After;
}

short DateStatus(stDate Date1, stDate Date2)
{
    enDateStatus Status =CompareDates(Date1, Date2);
...
int main()
{
    ...
    cout << "\nCompare Result = " << DateStatus(Date1, Date2);
