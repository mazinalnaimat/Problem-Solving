...
- `PARTITION BY CustomerName` restarts the calculation for each logical group.
- The frame `ROWS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING` controls which neighboring rows participate.
