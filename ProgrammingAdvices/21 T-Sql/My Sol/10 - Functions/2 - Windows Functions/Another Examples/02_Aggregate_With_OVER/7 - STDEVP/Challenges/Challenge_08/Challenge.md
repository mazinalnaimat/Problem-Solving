# Challenge 8: Utility costs farther than one running population deviation

## Required result

- Calculate the running average and running population standard deviation for each BuildingName-and-MeterType group.
- Return only rows whose `Cost` differs from its running average by more than one running population standard deviation.
