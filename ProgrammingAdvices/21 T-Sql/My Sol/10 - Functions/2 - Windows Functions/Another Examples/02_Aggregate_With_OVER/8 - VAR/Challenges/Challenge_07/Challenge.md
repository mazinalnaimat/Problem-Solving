# Challenge 7: Running average and sample variance of website revenue

## Required result

- Calculate both the running average and running sample variance for each SiteName-and-Channel group.
