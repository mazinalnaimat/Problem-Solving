# Challenge 1: Overall running sample variance of output units

## Required result

- Calculate a running sample variance across all returned rows without `PARTITION BY`.
...
- `ReadingTime`
- `OutputUnits`
- `OverallRunningOutputSampleVariance`

## Skills practiced

- Global ordered `VAR()` window
