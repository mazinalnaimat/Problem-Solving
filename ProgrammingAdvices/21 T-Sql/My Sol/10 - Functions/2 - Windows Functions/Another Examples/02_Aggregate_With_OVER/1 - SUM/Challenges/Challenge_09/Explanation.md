...
- `PARTITION BY MachineCode` restarts the calculation for each logical group.
- The frame `ROWS BETWEEN 1 PRECEDING AND CURRENT ROW` controls which neighboring rows participate.
