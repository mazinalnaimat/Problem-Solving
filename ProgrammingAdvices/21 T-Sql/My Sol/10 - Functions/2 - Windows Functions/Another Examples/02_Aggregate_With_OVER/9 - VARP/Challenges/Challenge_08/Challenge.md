# Challenge 8: Utility rows whose squared deviation exceeds running population variance

## Required result

- Calculate the running average and running population variance for each BuildingName-and-MeterType group.
- Return only rows whose squared difference from the running average is greater than the running population variance.
