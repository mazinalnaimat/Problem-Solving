# Challenge 6: Compare athlete and team running sample deviations

## Required result

- Calculate one running sample standard deviation for each `AthleteName`.
- Calculate a second running sample standard deviation for each `TeamName`.
...
- `RaceDate`
- `FinishSeconds`
- `AthleteNameRunningFinishSampleDeviation`
- `TeamNameRunningFinishSampleDeviation`
