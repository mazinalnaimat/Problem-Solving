...
- `CUME_DIST` returns a decimal between 0 and 1.
- Rows are compared only inside `BuildingName, MeterType`.
- Ties share the same ordering position according to `Consumption`.
