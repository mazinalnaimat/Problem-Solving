# Challenge 9: LAG challenge 9: previous machine defect count two readings away

## Task

Show every row and return the previous machine defect count two readings away within its logical group.
