# Challenge 10: PERCENTILE_CONT challenge 10: median ticket satisfaction

## Task

Show each detail row and calculate the median ticket satisfaction for its partition.

## Requirements

- Use `PERCENTILE_CONT(0.50)`.
- Order the percentile by `SatisfactionScore`.
