# Challenge 2: PERCENT_RANK challenge 2: delay inside each depot

## Task

Calculate the relative rank from 0 to 1 of delay inside each depot while keeping every detail row.
