# Challenge 4: PERCENT_RANK challenge 4: quantity inside each inventory category

## Task

Calculate the relative rank from 0 to 1 of quantity inside each inventory category while keeping every detail row.
