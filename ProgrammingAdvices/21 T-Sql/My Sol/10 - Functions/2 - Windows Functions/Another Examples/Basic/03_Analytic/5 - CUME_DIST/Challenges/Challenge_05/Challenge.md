# Challenge 5: CUME_DIST challenge 5: payment amount inside each plan

## Task

Calculate the cumulative distribution of payment amount inside each plan while keeping every detail row.
