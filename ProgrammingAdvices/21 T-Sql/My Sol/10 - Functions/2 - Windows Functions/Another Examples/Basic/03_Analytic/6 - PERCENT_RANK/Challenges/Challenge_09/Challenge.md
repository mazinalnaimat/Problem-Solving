# Challenge 9: PERCENT_RANK challenge 9: defect count inside each production line

## Task

Calculate the relative rank from 0 to 1 of defect count inside each production line while keeping every detail row.
