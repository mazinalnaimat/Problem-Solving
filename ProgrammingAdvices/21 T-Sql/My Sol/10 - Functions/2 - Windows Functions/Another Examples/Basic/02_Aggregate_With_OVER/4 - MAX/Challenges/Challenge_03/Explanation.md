...
- `PARTITION BY AgentName` restarts the calculation for each logical group.
- The frame `ROWS BETWEEN 2 PRECEDING AND CURRENT ROW` controls which neighboring rows participate.
