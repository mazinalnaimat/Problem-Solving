# Challenge 9: Population deviation of daily average defects by production line

## Required result

- First group the source rows by ProductionLine and calendar date.
- Calculate `DailyAverageDefectCount` for each grouped day.
- Then calculate a running population standard deviation of those daily averages.
...
- `RunningDailyDailyDefectPopulationDeviation`
