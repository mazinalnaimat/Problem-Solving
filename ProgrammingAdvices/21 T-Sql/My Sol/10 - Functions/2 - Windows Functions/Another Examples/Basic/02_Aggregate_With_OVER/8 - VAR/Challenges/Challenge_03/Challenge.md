# Challenge 3: Running sample variance of resolution time by team and priority

## Required result

- Restart the running sample variance for every unique combination of `TeamName` and `Priority`.
...
- `OpenedAt`
- `ResolutionMinutes`
- `RunningResolutionSampleVarianceByTwoGroups`

## Skills practiced

- Ordered `VAR()` with a multi-column partition
