# Challenge 7: Running average and sample deviation of website revenue

## Required result

- Calculate both the running average and running sample standard deviation for each SiteName-and-Channel group.
