# Challenge 4: Conditional sample variance of nonzero stock quantities

## Required result

- Calculate the running sample variance using only rows where `QuantityOnHand` is greater than zero.
...
- `SnapshotDate`
- `QuantityOnHand`
- `ConditionalRunningQuantitySampleVariance`
