...
The first-order month defines the cohort. Distinct customer-month activity prevents duplicate counting. A partition-only `MAX` carries month-zero size to every row of the cohort.
