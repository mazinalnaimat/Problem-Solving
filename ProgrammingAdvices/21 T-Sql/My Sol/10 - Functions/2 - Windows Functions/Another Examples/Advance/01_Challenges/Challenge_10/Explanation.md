...
Monthly revenue is compared with `LAG`. Only consecutive calendar months with positive growth survive, after which a date-minus-row-number island key groups streaks.
