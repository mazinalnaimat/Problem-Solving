...
Inventory movements are first converted into a current balance at product-warehouse grain. Ranking then finds the maximum stock location while preserving ties.
