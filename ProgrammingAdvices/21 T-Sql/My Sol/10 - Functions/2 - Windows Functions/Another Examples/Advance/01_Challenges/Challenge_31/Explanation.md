...
Split shipments are collapsed to one final-delivery event per order and warehouse. Ordered-set percentile functions then calculate distribution statistics while retaining window semantics.
